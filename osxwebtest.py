...
class AppiumMobileWebAppTest(unittest.TestCase):
    def setUp(self):
        ...
        self.desired_capabilities['name'] = 'Firefox 40 Test'     
        self.desired_capabilities['platform'] = 'OS X 10.10'
        self.desired_capabilities['browserName'] = 'firefox'        
        self.desired_capabilities['version'] = "40.0"
        # self.desired_capabilities['screenResolution'] = "1280x800"
        # self.desired_capabilities['chromedriverVersion'] = "2.15"
        # self.desired_capabilities['seleniumVersion'] = "2.31.0"
